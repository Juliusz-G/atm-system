...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Tutaj kawałek kody który pokazuje jakie dane zostały dodane przez -> manager.initializationData()
        // To "\033[0;33m" oznacza kolor wyświetlanego stringa, w tym wypadku żółty, a to "\u001B[0m" resetuje kolor na biała
        // Na żółto zostaną wyświetlone tylko gwiazdki, żeby odróżnić blok tekstu w którym znajdują się przykładowe dane
        // To zostanie wyświetlone tylko raz na początku programu
        ...
        while (choice != 0) {
            ...
            switch (choice) { // Wywołóje metodę która znajduję się pod danym wyborem
                case 0 -> {
                }

...
public class Manager {
    ...
    public void addAtm() {
        ...
        System.out.println("--Tworzenie bankomtu--");
    ...
    public void addCard() {
        ...
        cards.add(card); // Dodaje katę do lity kart
